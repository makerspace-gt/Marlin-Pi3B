...
#define STRING_CONFIG_H_AUTHOR "(igami, geeetech prusa i3 b)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "[g3ig3i]"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  80.57
  #define DEFAULT_bedKi  15.14
  #define DEFAULT_bedKd 285.95
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0, 80.0, 2560.0, 99.7 }
